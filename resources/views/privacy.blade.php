    ...
    <div class="products-breadcrumb">
        <div class="container">
            <ul>
                ...
                <li>{{ __('validation.sections.'.'Privacy Policy') }} & {{ __('validation.sections.'.'Terms of Use') }}</li>
            </ul>
        </div>
    </div>
    @parent
...
@section('slider-brands')
    ...
    <div class="w3l_banner_nav_right">
        ...
        <div class="privacy">
            <div class="privacy1">
                <h3>{{ __('validation.sections.'.'Privacy Policy') }}</h3>
            ...
            <div class="privacy1">
                <h3>{{ __('validation.sections.'.'Terms of Use') }}</h3>
