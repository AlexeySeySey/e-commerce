    ...
    <div class="products-breadcrumb">
        <div class="container">
            <ul>
                ...
                <li>{{ __('validation.sections.'.'Events') }}</li>
            </ul>
        </div>
    </div>
    @parent
...
@section('slider-brands')
    ...
    <div class="events">
        <h3>{{ __('validation.sections.'.'Events') }}</h3>
            ...
            <div class="col-md-6 events_bottom_left">
                <div class="col-md-4 events_bottom_left1">
                    <div class="events_bottom_left1_grid">
                        <h4>20</h4>
                        <p>{{ __('validation.time.'.'July') }}, 2016</p>
                    </div>
                </div>
                <div class="col-md-8 events_bottom_left2">
                    ...
                    <ul>
                        ...
                        <li><i class="fa fa-user" aria-hidden="true"></i><a href="#">{{ __('validation.other.'.'Admin') }}</a></li>
                    </ul>
