            ...
            <tr class="row"
                ...
                <td class="col">
                    <button type="button"
                        ...
                        id="changeadmincat{{ $key->id }}">
                        Изменить <i class="fa fa-edit"></i>
                    </button>
                    <div class="modal fade"
                        id="exampleModalLong{{ $key->id }}"
                        tabindex="-1"
                        role="dialog"
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"
                                        id="exampleModalLongTitle">Изменить категорию
                                ...
                                <div class="modal-body">
                                    ...
                                    <ul class="nav nav-pills mb-3"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active"
                                                ...
                                                aria-selected="true">Наименование</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link"
                                    ...
                                    <div class="tab-content"
                                        ...
                                        <div class="tab-pane fade show active"
                                            ...
                                            <div>
                                                <form action="{{ route('updateCatName') }}"
                                                    method="POST"
                                                    class="form-group">
                                                    @csrf
                                                    <table>
                                        ...
                                        <div class="tab-pane fade"
                                            ...
                                            <div>
                                                <form action="{{ route('updateCatImg') }}"
                                                    method="POST"
                    ...
                    <button class="btn btn-danger"
                        id="hideadmincat{{ $key->id }}"
                        onclick="hideCategorie({{ $key->id }})">Убрать <i class="fa fa-times-circle-o"></i></button>
                </td>
            </tr>
            @endforeach
            @else
